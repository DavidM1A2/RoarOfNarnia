...
public class WeaknessParticle extends NarniaParticle {
    public WeaknessParticle(ClientLevel clientLevel, double x, double y, double z, SpriteSet spriteSet) {
    ...
    public record Factory(SpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
            return new WeaknessParticle(level, x, y, z, spriteSet);
        }
    }
}
