...
public class ModSchematics {
    ...
    public static final DeferredHolder<Schematic, Schematic> DARK_CITY_SMALL_2 = SCHEMATICS.register("dark_city_small_2", Schematic::new);
    public static final DeferredHolder<Schematic, Schematic> DARK_CITY_SMALL_3 = SCHEMATICS.register("dark_city_small_3", Schematic::new);
    public static final DeferredHolder<Schematic, Schematic> DARK_CITY_SMALL_4 = SCHEMATICS.register("dark_city_small_4", Schematic::new);
    ...
    public static final DeferredHolder<Schematic, Schematic> DARK_CITY_GARDEN_2 = SCHEMATICS.register("dark_city_garden_2", Schematic::new);
    ...
    public static final DeferredHolder<Schematic, Schematic> DARK_CITY_PYRAMID_2 = SCHEMATICS.register("dark_city_pyramid_2", Schematic::new);
