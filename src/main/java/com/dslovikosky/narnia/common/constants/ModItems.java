...
public class ModItems {
    ...
    public static final DeferredItem<TheChroniclesOfNarniaBookItem> THE_MAGICIANS_NEPHEW = ITEMS.register("the_magicians_nephew", () -> new TheChroniclesOfNarniaBookItem(ModBooks.THE_MAGICIANS_NEPHEW));
