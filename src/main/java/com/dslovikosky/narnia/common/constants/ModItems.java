...
import com.dslovikosky.narnia.common.item.ancient.AncientSwordItem;
...
public class ModItems {
    ...
    public static final DeferredItem<AncientSwordItem> ANCIENT_SWORD = ITEMS.register("ancient_sword", AncientSwordItem::new);
