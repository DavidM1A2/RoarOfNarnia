...
public class ModChapters {
    ...
    public static final DeferredHolder<Chapter, ? extends Chapter> THE_WRONG_DOOR = CHAPTERS.register("the_wrong_door", id ->
            new Chapter(id, ModBooks.THE_MAGICIANS_NEPHEW, Lazy.of(() -> List.of(ModCharacters.DIGORY.get(), ModCharacters.POLLY.get(), ModCharacters.UNCLE_ANDREW.get())), List.of(new FindUncleAndrewsHouseGoal())));
