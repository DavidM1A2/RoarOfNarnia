...
public class ModBooks {
    ...
    public static final DeferredHolder<Book, ? extends Book> THE_MAGICIANS_NEPHEW = BOOKS.register("the_magicians_nephew",
            id -> new Book(id, List.of(
                    new Chapter(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "the_wrong_door"), List.of(new FindUncleAndrewsHouseGoal()), List.of(SPECTATOR, DIGORY, POLLY)),
                    new Chapter(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "digory_and_his_uncle"), List.of(), List.of(SPECTATOR, DIGORY)),
                    new Chapter(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "the_wood_between_the_worlds"), List.of(), List.of(SPECTATOR, DIGORY, POLLY)))));
}
