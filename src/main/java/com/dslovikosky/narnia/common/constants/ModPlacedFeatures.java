...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> WOOD_BETWEEN_THE_WORLDS_WATER_POOL = ResourceKey.create(Registries.PLACED_FEATURE, Constants.modLocation("wood_between_the_worlds_water_pool"));
