...
public class ModEntityTypes {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<DigoryEntity>> DIGORY = ENTITY_TYPES.register("digory", id -> EntityType.Builder.of(DigoryEntity::new, MobCategory.CREATURE)
            .sized(0.4F, 1.1F)
            .eyeHeight(0.9F)
            .ridingOffset(-0.7F)
