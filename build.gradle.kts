...
base {
    archivesName = project.extra["mod_id"] as String
}
...
sourceSets {
    main {
        resources {
            // Add a directory to the resources
...
dependencies {
    ...
    implementation("net.neoforged:neoforge:${project.extra["neo_version"] as String}")
    ...
    // This maps to ./libs/coolmod-${mc_version}-${coolproject.extra["mod_version"] as String}.jar
    // The group id is ignored when searching -- in this case, it is "blank"
    // implementation "blank:coolmod-${mc_version}:${coolproject.extra["mod_version"] as String}"

    // Example mod dependency using a file as dependency
    // implementation files("libs/coolmod-${mc_version}-${coolproject.extra["mod_version"] as String}.jar")
